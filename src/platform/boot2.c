/* RP2040 boot2 for W25Q080/W25Q16JV (Pico / Pico W).
   Source: rp-rs/rp2040-boot2 (pre-compiled, known-good binary).
   Original: pico-sdk boot2_w25q080.S (BSD-3-Clause, Raspberry Pi Trading Ltd) */
__attribute__((section(".boot2"), used))
const unsigned char boot2[256] = {
